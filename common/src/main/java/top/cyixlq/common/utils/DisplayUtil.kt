...
object DisplayUtil {
    ...
    fun getStatusbarHeight(): Int {
        ...
        try {
            ...
            statusBarHeight = CommonManager.getApplication().resources.getDimensionPixelSize(x)
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    fun px2dp(pxValue: Float): Int {
        val density = CommonManager.getApplication().resources.displayMetrics.density
    ...
    fun px2sp(pxValue: Float): Int {
        val scaleDensity = CommonManager.getApplication().resources.displayMetrics.scaledDensity
